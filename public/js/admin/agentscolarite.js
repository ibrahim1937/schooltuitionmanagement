$(document).ready(function() {
    $.ajax({
        ...
        success: function(data) {
            console.log(data);
            fillAll(".display", $("#content-agents"), data);
        },
    ...
    $("#modifier").click(function(e) {
        ...
        $.ajax({
            ...
            data: {
                ...
                email: $("#emailm").val(),
                cin: $("#cinm").val(),
                id: sessionStorage.getItem("idagents")
            },
            dataType: "json",
            success: function(data) {
                ...
                if (data.error) {
                    ...
                    fillAll(".display", $("#content-agents"), data.data);
                    $("#exampleModal").modal("hide");
                    $("#form-modifier")[0].reset();
                    hideErrorsAfterSubmit("modifier");
                    sessionStorage.removeItem("idagents");
                }
            },
            error: function(error) {
                console.log(error);
