...
<div class="container-fluid">
    <div class="row shadow" style="overflow: hidden;">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-dark text-center">Vos demandes rectifications acceptée : </h5>
...
@section('scripts')
    <script>
        let accepterRectifier1 = "{{ route('etudiant.accepterRectifier1') }}";

    </script>

    <script src="{{ asset('js/etudiant/accepterRectifier.js') }}"></script>
