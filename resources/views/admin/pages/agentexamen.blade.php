...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class=" mb-2 text-gray-800 text-center">Gestion Agent d'examen</h1>

    <div class="row shadow formcontainer">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Ajouter un Agent d'examen :
            </h6>
        </div>
    ...
    <div class="row shadow" style="overflow: hidden;">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Liste Des Agents d'examen: </h6>
            <div class="row">
        ...
        <div class="row table-responsive">
                ...
                <table class="table table-stripped table-hover table-bordered display" style="overflow: auto;">
                    ...
                    <tbody id="content-agente" style="overflow: auto;">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Modifier Agent d'examen</h5>
...
@section('scripts')
<script>
    let gestionurl =  "{{ route('admin.gestionagentexamen') }}";
</script>

<script src="{{ asset('js/admin/agentexamen.js') }}"></script>
