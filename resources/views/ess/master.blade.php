    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('ess.dashboard') }}">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route('ess.dashboard') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('ess.accepterparese') }}">
                        <i class="fas fa-check"></i>
                        <span>Demandes des examens</span></a>
                </li>


                <!-- Nav Item - Pages Collapse Menu -->
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('ess.demande') }}">
                        <i class="fab fa-accusoft"></i>
                        <span>Demandes des scolarites</span></a>
                </li>
                <hr class="sidebar-divider">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('ess.accepter') }}">
                        <i class="fas fa-clipboard-list"></i>
                        <span>Prêt à livrer</span></a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="{{ route('ess.livree') }}">
                        <i class="fas fa-clipboard-check"></i>
                        <span>Demandes livrées</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('ess.refuser') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('ess.historique') }}">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item" href="{{ route('ess.profilepage') }}">
