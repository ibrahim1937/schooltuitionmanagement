...
<div class="container-fluid">
    <div class="row shadow" style="overflow: hidden;">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-dark text-center">Historique de toutes les demandes scolarite et examen: </h5>
...
@section('scripts')
    <script>
        let historique1 = "{{ route('ess.historique') }}";

    </script>
    <script src="{{ asset('js/ess/historique.js') }}"></script>
@endsection
