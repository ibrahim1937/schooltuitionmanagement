...
<div class="container-fluid">
    <div class="row shadow" style="overflow: hidden;">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-dark text-center">Demandes  refusée par l'agent de scolarite : </h5>
...
@section('scripts')
    <script>
        let refuser1 = "{{ route('ess.refuser') }}";

    </script>
    <script src="{{ asset('js/ess/refuser.js') }}"></script>
@endsection
