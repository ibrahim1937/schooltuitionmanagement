        ...
        <div class="container-fluid">
                  ...
                  <div class="modal-content">
                    ...
                    <form action="" id="form-modifier">
                        <div class="modal-body errorparent">
                            <div class="form-row">
                                {{-- <div class="col-sm-11">
                                    <label for="nomm">Date de livraison</label>
                                    <input type="text" class="form-control m-3" placeholder="livraison on" id="date">
                                </div> --}}
            ...
            <div class="row shadow" style="overflow: hidden;">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-dark text-center">Demandes  envoyée par les étudiants: </h5>
                    <form id="add">
...
@section('scripts')
    <script>
        let gestiondemandel = "{{ route('ess.gestiondemande') }}";

    </script>
    <script src="{{ asset('js/ess/demande.js') }}"></script>
@endsection
