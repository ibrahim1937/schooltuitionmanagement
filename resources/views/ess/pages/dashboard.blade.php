...
<div class="container-fluid">
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class=" mb-2 text-gray-800">Bienvenue dans l'espace service scolarité</h1>
        <div class="row">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-center small">
                            <a target="_blank" rel="nofollow" href="{{ route('ess.demande') }}">Voir plus →
                               </a>
...
@section('scripts')
<script>
    let chart2 = "{{ route('ess.chart2') }}";

</script>
    <script src="{{ asset('js/charts/chart2.js') }}"></script>
@endsection
