...
<div class="container-fluid">
    <div class="row shadow" style="overflow: hidden;">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-dark text-center">Demandes  acceptée par agent examen : </h5>
        </div>
...
@section('scripts')
    <script>
        let accepter2 = "{{ route('ese.eseaccepter') }}";

    </script>
    <script src="{{ asset('js/ese/accepter.js') }}"></script>
@endsection
