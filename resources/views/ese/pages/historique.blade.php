...
<div class="container-fluid">
    <div class="row shadow" style="overflow: hidden;">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-dark text-center">Historique des demandes d'examens : </h5>
...
@section('scripts')
    <script>
        let historique2 = "{{ route('ese.esehistorique') }}";

    </script>
    <script src="{{ asset('js/ese/historique.js') }}"></script>
@endsection
