    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('ese.dashboard') }}">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route('ese.dashboard') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('ese.demandes') }}">
                        <i class="fab fa-accusoft"></i>
                        <span> Demandes en cours</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('ese.accepter') }}">
                        <i class="fas fa-clipboard-list"></i>
                        <span>Demandes acceptées</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('ese.livree') }}">
                        <i class="fas fa-clipboard-check"></i>
                        <span>Demandes Livreés</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('ese.refuser') }}">
                        <i class="fas fa-book-dead"></i>
                        <span>Demandes refusée</span></a>
                </li>
                <hr class="sidebar-divider">
                <div class="sidebar-heading">
                    Plus d'information
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('ese.historique') }}">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item" href="{{ route('ese.profilepage') }}">
