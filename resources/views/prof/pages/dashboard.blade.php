...
<div class="container-fluid">
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class=" mb-2 text-gray-800">Bienvenue cher professeur</h1>
        <div class="row">
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-7">
                <div class="card shadow mb-4">
                    ...
                    <div
                        ...
                        <h6 class="m-0 font-weight-bold text-primary">aperçu sur les réctifications arrivée des étudiants</h6>
            ...
            <div class="col-xl-8 col-lg-5" >
                <div class="card shadow mb-4">
                    ...
                    <div
                        class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Les réctifications arrivée des étudiants
                        </h6>
                        <div class="dropdown no-arrow">
                            <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-center small">
                            <a target="_blank" rel="nofollow" href="{{ route('prof.rectifier') }}">Voir plus →
                               </a>
...
@section('scripts')
    <script>
        let chart4 = "{{ route('prof.chart4') }}";

    </script>
        <script src="{{ asset('js/charts/chart4.js') }}"></script>
@endsection
