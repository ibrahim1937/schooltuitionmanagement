...
<div class="container-fluid">
    <div class="row shadow" style="overflow: hidden;">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-dark text-center">Demandes rectifications refusées :  </h5>
...
@section('scripts')
    <script>
        let refuser1 = "{{ route('prof.refuser') }}";

    </script>
    <script src="{{ asset('js/prof/refuser.js') }}"></script>
@endsection
